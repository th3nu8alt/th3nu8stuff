...
class Player extends events_1.EventEmitter {
    constructor(socket) {
         ...
         */
        this.destroyTool = this.removeTool;
        Player.playerId += 1;
        this.socket = socket;
   ...
   **/
    ...
    equipTool(tool) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (currentTool)
                yield this.unequipTool(currentTool);
    ...
    setAvatar(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const assetPacket = (0, assetIds_1.default)(this, "QUVWjklmn");
   ...
   */
    ...
    _createFigures() {
        ...
        (0, playerIds_1.default)(this, "ABCDEFGHIKLMNOPXYf")
            .broadcastExcept([this]);
        (0, assetIds_1.default)(this, "QUVWgjklmn").then((packet) => {
        ...
        for (const player of Game_1.default.players) {
            if (player !== this) {
                (0, playerIds_1.default)(player, "ABCDEFGHIKLMNOPXYf")
                    .send(this.socket);
                (0, assetIds_1.default)(player, "QUVWgjklmn").then((packet) => {
